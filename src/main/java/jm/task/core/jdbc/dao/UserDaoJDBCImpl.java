...
public class UserDaoJDBCImpl implements UserDao {
    ...
    private final static String TABLE_CLEAN_QUERY = "DELETE FROM " + TABLE_NAME;
    ...
    public void saveUser(String name, String lastName, byte age) {
        try (Connection connection = Util.getConnection()) {
            try (PreparedStatement preparedStatement = connection.prepareStatement(TABLE_SAVE_USER_QUERY)) {
    ...
    public void removeUserById(long id) {
        try (Connection connection = Util.getConnection()) {
            try (PreparedStatement preparedStatement = connection.prepareStatement(TABLE_DELETE_BY_ID)) {
